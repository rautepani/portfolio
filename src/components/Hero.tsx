      ...
      <div className={`hero-content ${heroContentIn ? 'in' : ''} font-spaceGrotesk`} id="heroContent">
        <div className="hero-grid">
          <div className="hero-text">
            ...
            <p className="hero-desc font-spaceGrotesk">
              Software Engineer building secure, scalable software and occasionally becoming the
              vulnerability I was trying to prevent.
            </p>
            ...
            <div className="social-row font-jetbrainsMono">
              ...
              <a className="chip" href={SOCIAL_LINKS.twitter} target="_blank" rel="noreferrer" style={{ display: 'inline-flex', alignItems: 'center', gap: '6px' }}>
